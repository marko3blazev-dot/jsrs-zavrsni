            ...
            <div className="footer-content">
                ...
                <div className="footer-section links">
                    ...
                    <ul>
                        ...
                        <li><a href="/kumstvo">Udomljavanje i kumstvo</a></li>
                ...
                <div className="footer-section contact">
                    ...
                    <div className="contact-buttons-container">
                        <a href="https://maps.google.com/search?q=Ulica+Hrvatskih+Žrtava+85%2C+21210+Solin"
                            target="_blank"
                            rel="noopener noreferrer"
                            className="contact-btn"
                            aria-label="Adresa (Google Maps)">
                        ...
                        <a href="mailto:marko3blazev@gmail.com"
                            className="contact-btn"
